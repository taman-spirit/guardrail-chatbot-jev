...
| Quand une conversation est considérée comme récemment risquée | [`Session.watching`](python/src/guardrail_chatbot_jev/session.py#L95) |
| Messages arrêtés conservés comme repère, cachés au modèle | [`Session.record`](python/src/guardrail_chatbot_jev/session.py#L84), [`model_history`](python/src/guardrail_chatbot_jev/session.py#L91) |
