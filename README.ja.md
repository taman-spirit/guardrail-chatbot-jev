...
ベトナムパック（[`vietnam-compliance-v1`](policies/vietnam-compliance-v1.json)）は次のカテゴリを加える。他は上の表のまま。

| カテゴリ | 名前 | Flag / review / block | 出力 | 備考 |
| --- | --- | --- | --- | --- |
| `vsv` | Territorial sovereignty of Viet Nam | 0.15 / 0.3 / 0.5 | 0.1 / 0.22 / 0.4 | センチネル |
| `vas` | Propaganda against the State | 0.15 / 0.3 / 0.55 | = |  |
| `vld` | Insulting national leaders and symbols | 0.14 / 0.28 / 0.5 | 0.1 / 0.2 / 0.4 | センチネル |
